...
module tb_queue;
    ...
    initial begin
        i = 0;
        qc_i_clk = 1'b0;
        // initialize control signals to avoid X propagation
        qc_i_we_1 = 1'b0; qc_i_we_2 = 1'b0;
        qc_i_re_1 = 1'b0; qc_i_re_2 = 1'b0;
        qc_i_ce_1 = 1'b0; qc_i_ce_2 = 1'b0;
        qc_i_reg_write_1 = 1'b0; qc_i_reg_write_2 = 1'b0;
        qc_i_reg_dst_1 = 1'b0; qc_i_reg_dst_2 = 1'b0;
        qc_i_alu_src_1 = 1'b0; qc_i_alu_src_2 = 1'b0;
        qc_i_memtoreg_1 = 1'b0; qc_i_memtoreg_2 = 1'b0;
        qc_i_memwrite_1 = 1'b0; qc_i_memwrite_2 = 1'b0;
        qc_i_jr_1 = 1'b0; qc_i_jal_1 = 1'b0; qc_i_jr_2 = 1'b0; qc_i_jal_2 = 1'b0;
        qc_i_imm_1 = {`IMM_WIDTH{1'b0}}; qc_i_imm_2 = {`IMM_WIDTH{1'b0}};
        qc_i_funct_1 = {`FUNCT_WIDTH{1'b0}}; qc_i_funct_2 = {`FUNCT_WIDTH{1'b0}};
        qc_i_opcode_1 = {`OPCODE_WIDTH{1'b0}}; qc_i_opcode_2 = {`OPCODE_WIDTH{1'b0}};
        qc_i_jal_addr_1 = {`JUMP_WIDTH{1'b0}}; qc_i_jal_addr_2 = {`JUMP_WIDTH{1'b0}};
        qc_i_data_rs_1 = {`DWIDTH{1'b0}}; qc_i_data_rt_1 = {`DWIDTH{1'b0}};
        qc_i_data_rs_2 = {`DWIDTH{1'b0}}; qc_i_data_rt_2 = {`DWIDTH{1'b0}};
        qc_i_addr_rd_1 = {`AWIDTH{1'b0}}; qc_i_addr_rs_1 = {`AWIDTH{1'b0}}; qc_i_addr_rt_1 = {`AWIDTH{1'b0}};
        qc_i_addr_rd_2 = {`AWIDTH{1'b0}}; qc_i_addr_rs_2 = {`AWIDTH{1'b0}}; qc_i_addr_rt_2 = {`AWIDTH{1'b0}};
    end
    ...
    task load_1 (input integer counter);
        begin
            ...
            qc_i_ce_1 = 1'b1;
            qc_i_ce_2 = 1'b1;
            qc_i_reg_write_1 = 1'b1;
            qc_i_reg_write_2 = 1'b1;
            for (i = 0; i < counter; i = i + 1) begin
                // set inputs BEFORE the rising edge
                qc_i_addr_rd_1 = i;
                qc_i_addr_rs_1 = i;
                qc_i_addr_rt_1 = i;
                qc_i_addr_rd_2 = i;
                qc_i_addr_rs_2 = i;
                qc_i_addr_rt_2 = i;
                @(posedge qc_i_clk); // queue samples values on the rising edge
            end
            qc_i_we_1 = 1'b0;
            qc_i_we_2 = 1'b0;
            qc_i_ce_1 = 1'b0;
            qc_i_ce_2 = 1'b0;
            qc_i_reg_write_1 = 1'b0;
            qc_i_reg_write_2 = 1'b0;
            @(posedge qc_i_clk);
        end
    endtask
    ...
    task display (input integer counter);
        begin
            qc_i_re_1 = 1'b1;
            for (i = 0; i < counter; i = i + 1) begin
                $display($time, " idx=%d: qc_o_addr_rd_1 = %d, qc_o_addr_rs_1 = %d, qc_o_addr_rt_1 = %d", 
                        i, qc_o_addr_rd_1, qc_o_addr_rs_1, qc_o_addr_rt_1);
                @(posedge qc_i_clk);
            end
            qc_i_re_1 = 1'b0;
            @(posedge qc_i_clk);
