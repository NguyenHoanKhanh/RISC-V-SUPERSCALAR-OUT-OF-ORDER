...
module rename_unit (
  ...
  wire [`RAT_SIZE - 1 : 0] ru_prf_prs_1;
  wire [`RAT_SIZE - 1 : 0] ru_prf_prt_1;
  wire [`RAT_SIZE - 1 : 0] ru_prf_prs_2;
  wire [`RAT_SIZE - 1 : 0] ru_prf_prt_2;
  ...
  RAT u_rat (
    ...
    .rat_o_prs_1_prf(ru_prf_prs_1),
    .rat_o_prt_1_prf(ru_prf_prt_1),
    ...
    .rat_o_prs_2_prf(ru_prf_prs_2),
    .rat_o_prt_2_prf(ru_prf_prt_2),
  ...
  PRF u_prf (
    ...
    .pr_id_rs_1(ru_prf_prs_1),
    .pr_id_rt_1(ru_prf_prt_1),
    .pr_id_rs_2(ru_prf_prs_2),
    .pr_id_rt_2(ru_prf_prt_2),
