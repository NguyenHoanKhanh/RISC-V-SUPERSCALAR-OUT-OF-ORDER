...
//     assign sq_free_count = `SQ_SIZE - sq_o_count;
//     assign lq_free_count = `LQ_SIZE - lq_o_count;
//     assign sq_need_pair = {{`ROB_IDX_W{1'b0}}, sq_need_1} + {{`ROB_IDX_W{1'b0}}, sq_need_2};
//     assign lq_need_pair = {{`ROB_IDX_W{1'b0}}, lq_need_1} + {{`ROB_IDX_W{1'b0}}, lq_need_2};
//     assign sq_lane1_ok = (!sq_need_1) || (sq_free_count >= 1);
//     assign lq_lane1_ok = (!lq_need_1) || (lq_free_count >= 1);
//     assign sq_pair_ok = (sq_free_count >= sq_need_pair);
//     assign lq_pair_ok = (lq_free_count >= lq_need_pair);
//     assign sq_lane2_solo_ok = (!sq_need_2) || (sq_free_count >= 1);
//     assign lq_lane2_solo_ok = (!lq_need_2) || (lq_free_count >= 1);

//     assign dispatch_can_take_1 = rob_o_can_alloc_1 & rs_credit_can_alloc_1 & sq_lane1_ok & lq_lane1_ok;
//     assign dispatch_can_take_2_pair = rob_o_can_alloc_2 & rs_credit_can_alloc_2 & sq_pair_ok & lq_pair_ok;
//     assign dispatch_can_take_2_solo = rob_o_can_alloc_1 & rs_credit_can_alloc_1 & sq_lane2_solo_ok & lq_lane2_solo_ok;
